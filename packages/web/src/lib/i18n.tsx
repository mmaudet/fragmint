...
const translations = {
  ...
  planGeneration: {
    ...
    matchLegendTitle: { fr: 'Score de pertinence', en: 'Relevance score' },
    matchLegendStrong: { fr: 'similarité cosine ≥ 70 % — fragment très aligné avec la section.', en: 'cosine similarity ≥ 70% — fragment closely aligned with the section.' },
    matchLegendMedium: { fr: 'similarité cosine 55–70 % — fragment pertinent mais partiel.', en: 'cosine similarity 55–70% — relevant but partial match.' },
    matchLegendWeak: { fr: 'similarité cosine < 55 % — fragment peu aligné, à évaluer manuellement.', en: 'cosine similarity < 55% — low alignment, review manually.' },
    matchLegendUnscored: { fr: 'recherche textuelle (Milvus non actif) — pas de score vectoriel disponible.', en: 'text search (Milvus not active) — no vector score available.' },
