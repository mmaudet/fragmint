...
const translations = {
  ...
  fragments: {
    ...
    allFunctions: { fr: 'Toutes les fonctions', en: 'All functions' },
    allAudiences: { fr: 'Toutes les audiences', en: 'All audiences' },
    allMaturities: { fr: 'Toutes les phases produit', en: 'All maturities' },
    maturityLabel: { fr: 'Phase produit', en: 'Product phase' },
    functionTechnical: { fr: 'Technique', en: 'Technical' },
    functionCommercial: { fr: 'Commercial', en: 'Commercial' },
    functionLegal: { fr: 'Juridique', en: 'Legal' },
    functionOperational: { fr: 'Opérationnel', en: 'Operational' },
    functionStrategic: { fr: 'Stratégique', en: 'Strategic' },
    functionReference: { fr: 'Référence', en: 'Reference' },
    audienceTechnical: { fr: 'Technique', en: 'Technical' },
    audienceDecisionMaker: { fr: 'Décideur', en: 'Decision-maker' },
    audienceUser: { fr: 'Utilisateur', en: 'User' },
    audienceLegal: { fr: 'Juridique', en: 'Legal' },
    maturityProduction: { fr: 'Production', en: 'Production' },
    maturityBeta: { fr: 'Beta', en: 'Beta' },
    maturityRoadmap: { fr: 'Roadmap', en: 'Roadmap' },
    maturityArchive: { fr: 'Archive', en: 'Archive' },
