  ...
  fragments: [
    {
      ...
      author: 'mmaudet',
      title: 'Introduction souveraineté',
      body_excerpt: 'Dans un contexte où la dépendance...',
      body: '# Introduction\n\nTexte complet.',
      created_at: '2026-03-14',
      updated_at: '2026-03-14',
      uses: 5,
      file_path: 'fragments/test.md',
    },
    {
      id: 'frag-002',
      type: 'argument',
      ...
      author: 'mmaudet',
      title: 'Open RAG vs propriétaire',
      body_excerpt: 'Les solutions propriétaires...',
      body: '# Argument\n\nTexte argument.',
      created_at: '2026-03-14',
      updated_at: '2026-03-14',
      uses: 3,
      file_path: 'fragments/test2.md',
    },
    {
      id: 'frag-003',
      type: 'pricing',
      ...
      author: 'mmaudet',
      title: 'Tarification Twake',
      body_excerpt: 'Twake Workplace est disponible...',
      body: '# Pricing\n\nTarifs.',
      created_at: '2026-03-14',
      updated_at: '2026-03-14',
      uses: 0,
      file_path: 'fragments/test3.md',
    },
  ],
  inventory: {
    total: 3,
    by_type: { introduction: 1, argument: 1, pricing: 1 },
...
export const handlers = [
  http.post('/v1/auth/login', () => {
    return HttpResponse.json({
      data: {
        ...
        user: { login: 'mmaudet', role: 'admin', display_name: 'Michel-Marie' },
      },
      meta: null,
      error: null,
    });
  ...
  http.get('/v1/fragments/:id', ({ params }) => {
    ...
    if (!frag)
      return HttpResponse.json({ data: null, meta: null, error: 'Not found' }, { status: 404 });
    return HttpResponse.json({ data: frag, meta: null, error: null });
  }),
  http.post('/v1/fragments/search', () => {
    return HttpResponse.json({
      data: fixtures.fragments.slice(0, 1),
      meta: { count: 1 },
      error: null,
    });
  }),
